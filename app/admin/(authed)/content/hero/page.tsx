...
export default async function HeroContentPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      <AdminPageHeader
        title="Hero baner"
        description="Pozadina (slika, video, YouTube), naslovi i tekstovi dugmadi na ME i EN. Desno uživo pregled dok uređujete tekst."
      />
      <AdminFrontendHint>
        {frontendHintForAdminPath("content/hero")}
      </AdminFrontendHint>
