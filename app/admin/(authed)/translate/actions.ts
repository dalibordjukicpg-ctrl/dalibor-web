...
export async function translateAndSaveAllSiteStringsAction(
  ...
  try {
    ...
    revalidatePath("/admin/content/showcase");
    revalidatePath("/admin/content/design3d");
    revalidatePath("/admin/content/about");
    revalidatePath("/admin/content/consult");
    revalidatePath("/admin/content/home-cards");
    revalidatePath("/admin/content/blog-headings");
    revalidatePath("/admin/content/header-footer");
    revalidatePath("/admin/content/header");
