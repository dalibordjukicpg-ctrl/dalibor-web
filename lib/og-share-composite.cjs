...
const COPY = {
  me: { tagline: "Pejzažna arhitektura i dizajn eksterijera", city: "Simple Solutioning" },
  en: { tagline: "Landscape architecture and exterior design", city: "Simple Solutioning" },
  ru: { tagline: "Ландшафтная архитектура", city: "Simple Solutioning" },
};
