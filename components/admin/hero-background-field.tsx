...
export function HeroBackgroundField({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap gap-2">
        {(
          ...
          <button
            ...
            className={
              source === id
                ? "rounded-lg bg-[var(--site-brand)] px-3 py-1.5 text-sm font-medium text-white"
                : "rounded-lg border border-[var(--site-border)] bg-white px-3 py-1.5 text-sm text-[#5c4f44] hover:bg-[#fff9f5]"
            }
          >
            {label}
          </button>
        ...
        <div className="mt-5 space-y-4">
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-sm font-medium hover:bg-[#fff9f5]"
            >
              <ImageIcon className="h-4 w-4 text-[var(--site-brand)]" aria-hidden />
              Iz galerije
            </button>
            <label className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-sm font-medium hover:bg-[#fff9f5]">
              <Upload className="h-4 w-4 text-[var(--site-brand)]" aria-hidden />
              <input
                type="file"
          ...
          <select
            ...
            className="w-full rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-sm"
          >
          ...
          <p className="text-xs text-[#6b5f54]">
            Sve datoteke su u{" "}
            <Link href={adminPath("media")} className="text-[var(--site-brand-hover)] underline">
              Mediji
            </Link>
            .
          </p>
        ...
        <div className="mt-5 space-y-2">
          <label className="block text-sm">
            ...
            <div className="mt-1 flex items-center gap-2">
              <Link2 className="h-4 w-4 shrink-0 text-[var(--site-brand)]" aria-hidden />
              <input
                value={externalUrl}
      ...
      {previewUrl ? (
        <div className="mt-5 overflow-hidden rounded-xl border border-[var(--site-border)]">
        ...
        <p className="mt-4 flex items-center gap-2 text-sm text-[#6b5f54]">
          <Film className="h-4 w-4 text-[var(--site-brand)]" aria-hidden />
