    ...
    <div className="lg:sticky lg:top-4">
      ...
      <div className="relative overflow-hidden rounded-xl border border-neutral-200 bg-gradient-to-b from-orange-50/95 via-white to-white shadow-sm">
        ...
        <div className="relative p-6">
          ...
          <h2 className="hero-display-title hero-display-title--on-light mt-3 max-w-none">
            <span className="hero-display-title__line1 text-2xl md:text-3xl">
              {s("hero.line1")}
            </span>
            <span className="hero-display-title__line2 text-[1.65rem] md:text-[2rem]">
              {s("hero.line2")}
            </span>
          </h2>
