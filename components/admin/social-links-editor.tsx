          ...
          <div key={key} className="block text-sm">
            ...
            <div className="flex flex-wrap gap-2">
              <input
                ...
                className="min-w-[min(100%,16rem)] flex-1 rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-[#3d342c] outline-none focus:border-[#c9a88a] focus:ring-1 focus:ring-[#c9a88a]"
                autoComplete="off"
                inputMode="url"
              />
              <button
                ...
                className="shrink-0 rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-sm font-medium text-[#5c4f44] hover:bg-[#fff9f5] disabled:cursor-not-allowed disabled:opacity-40"
              >
                Ukloni
              </button>
            </div>
