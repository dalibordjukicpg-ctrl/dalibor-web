    ...
    <div className="flex shrink-0 gap-1">
      <form action={moveNavLinkOrderAction}>
        ...
        <button
          type="submit"
          title="Gore"
          className="rounded-md border border-[var(--site-border)] bg-white px-2 py-1 text-xs text-[#5c4f44] hover:bg-[#fff9f5]"
        >
          ↑
        </button>
      </form>
      ...
      <div className="mt-3 flex flex-wrap items-end gap-3">
        <label className="text-sm">
          ...
          <input
            ...
            className="mt-1 rounded-lg border border-[var(--site-border)] bg-white px-3 py-2 text-sm"
          />
        </label>
        ...
        <button
          type="submit"
          className="rounded-lg bg-[var(--site-brand)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--site-brand-hover)]"
        >
          {buttonLabel}
        </button>
      </div>
    ...
    <div className="space-y-8">
        ...
        roots.map((root) => {
          ...
          return (
            <AdminPanel
              ...
              className="border-l-4 border-l-[var(--site-brand)]/70"
            >
              <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
                <p className="text-xs font-semibold uppercase tracking-wide text-[var(--site-brand-hover)]">
                  Glavna kategorija
                </p>
      ...
      <p className="text-sm text-[#6b5f54]">
        ...
        <Link
          ...
          className="font-medium text-[var(--site-brand-hover)] underline"
        >
          Footer i kontakt
        </Link>
        . CMS stranice:{" "}
        <Link href={adminPath("pages")} className="font-medium text-[var(--site-brand-hover)] underline">
          Stranice
        </Link>
        .
      </p>
