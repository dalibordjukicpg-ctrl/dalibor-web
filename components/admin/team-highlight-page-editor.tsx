...
export function TeamHighlightPageEditor({
  ...
  if (!page) {
    return (
      <div className="rounded-lg border border-dashed border-[var(--site-border)] bg-[#fffbf7] p-4 space-y-3">
        ...
        <label className="block text-xs font-medium text-[#5c4f44]">
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-[var(--site-border)] px-3 py-2 font-mono text-sm"
        ...
        <button
          ...
          onClick={createPage}
          className="rounded-lg bg-[var(--site-brand)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--site-brand-hover)] disabled:opacity-60"
        >
  ...
  return (
    <div className="rounded-lg border border-[var(--site-border)] bg-[#fffbf7] p-4 space-y-4">
      ...
      <div className="flex flex-wrap gap-1 border-b border-[var(--site-border)] pb-2">
        {locales.map((loc) => (
          <button
            key={loc}
            type="button"
        ...
        >
          <label className="block text-xs font-medium text-[#5c4f44]">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-[var(--site-border)] px-3 py-2 text-sm"
            />
          </label>
          <div>
            ...
            <div className="mt-1 rounded-lg border border-[var(--site-border)] bg-white">
              <TiptapEditor
