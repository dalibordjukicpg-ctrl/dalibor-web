        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-[var(--site-brand)] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[var(--site-brand-hover)] disabled:opacity-50"
            >
              {generateRunning ? (
            ...
            {anyJobRunning ? (
              <button
                type="button"
                onClick={stopAll}
                className="rounded-lg border border-[var(--site-border)] bg-white px-4 py-2.5 text-sm font-medium text-[#5c4f44] hover:bg-[#fff9f5]"
              >
                Zaustavi
              </button>
            ) : null}
        ...
        {generateProgress && generateRunning && (
          <div className="mt-4 space-y-2">
            ...
            <div className="h-2 w-full overflow-hidden rounded-full bg-[#f5ece3]">
              <div
                className="h-full bg-[var(--site-brand)] transition-all duration-300"
      ...
      <div className="rounded-2xl border border-[#f0e6dc] bg-white/90 p-5 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <label className="mt-3 inline-flex cursor-pointer items-center gap-2 select-none">
              <span
                ...
                className={[
                  ...
                  missingOnly ? "bg-[var(--site-brand)]" : "bg-zinc-300",
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[var(--site-border)] bg-white px-5 py-2.5 text-sm font-semibold text-[#5c4f44] shadow-sm transition hover:bg-[#fff9f5] disabled:opacity-50"
          >
            {bulkRunning ? (
              <Loader2 className="h-4 w-4 animate-spin" aria-hidden />
            ) : (
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <label className="flex min-w-[260px] cursor-pointer items-start gap-3">
                  <input
                    ...
                    className="mt-1 h-4 w-4 rounded border-[#d8c9b9] text-[var(--site-brand)] focus:ring-[var(--site-brand)]"
                  />
                  <span>
              ...
              <div className="mt-4 h-2 w-full overflow-hidden rounded-full bg-[#f5ece3]">
                <div
                  className={`h-full transition-all duration-300 ${
                    run.failed > 0 ? "bg-amber-500" : "bg-[var(--site-brand)]"
                  }`}
                  style={{ width: `${pct}%` }}
                />
              </div>
