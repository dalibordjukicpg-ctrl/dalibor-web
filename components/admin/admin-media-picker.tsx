                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      item.fileMissing
                        ...
                        : "border-neutral-200 transition hover:border-[var(--site-brand)] hover:ring-2 hover:ring-[var(--site-brand)]/30 focus:outline-none focus:ring-2 focus:ring-[var(--site-brand)]",
                    )}
                  >
                    {item.fileMissing ? (
