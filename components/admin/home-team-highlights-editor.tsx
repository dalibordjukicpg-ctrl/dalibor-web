  ...
  return (
    <div className="space-y-4">
      ...
      {initialItems.length === 0 ? (
        <p className="rounded-lg border border-dashed border-[var(--site-border)] bg-[#fffbf7] px-4 py-3 text-sm text-[#6b5f54]">
      ...
      <button
        ...
        disabled={pending}
        onClick={add}
        className="rounded-lg border border-[var(--site-border)] bg-white px-4 py-2 text-sm font-medium text-[#5c4f44] hover:bg-[#fff9f5] disabled:opacity-60"
      >
        + Dodaj karticu
      </button>
    </div>
