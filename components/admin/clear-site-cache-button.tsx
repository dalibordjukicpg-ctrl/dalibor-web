    ...
    <div className="flex flex-col items-end gap-1 sm:flex-row sm:items-center">
      <form action={formAction} className="flex flex-col items-end gap-1">
        <button
          ...
          className={cn(
            "rounded-lg border border-[var(--site-border)] bg-[var(--site-surface-a)] px-3 py-1.5 text-sm font-semibold uppercase tracking-wide text-[var(--site-brand)]",
            "hover:bg-[var(--site-brand)] hover:text-white",
            "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--site-brand)]",
          )}
        >
          <SubmitLabel />
        </button>
